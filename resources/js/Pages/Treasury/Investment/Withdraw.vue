...
const withdrawAll = () => {
    const balance = props.investment?.beginning_balance || 0;
...
const handleSubmit = () => {
    ...
    router.post(
        `/treasury/investment/${props.investment.id}/withdraw`,
        { amount: form.value.amount, explanation: form.value.explanation },
        {
            onSuccess: () => {
                Swal.fire({
                    title: 'Withdrawn!',
                    text: 'Investment withdrawal has been recorded successfully.',
                    icon: 'success',
            ...
            onError: (errors) => {
                if (errors.message) {
                    ...
                    Swal.fire({ title: 'Error!', text: 'Failed to record withdrawal. Please try again.', icon: 'error', confirmButtonColor: '#F59E0B' });
                }
            },
        ...
        <div v-if="isOpen" class="fixed inset-0 bg-black/50 flex items-center justify-center z-50 p-4">
            <div class="bg-white rounded-xl shadow-2xl w-full max-w-md">
                <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200">
                    <h2 class="text-xl font-bold text-gray-900">Withdraw Investment</h2>
                ...
                <form @submit.prevent="handleSubmit" class="px-6 py-4 space-y-4">
                    <div v-if="investment" class="bg-orange-50 rounded-lg p-3 border border-orange-200">
                    ...
                    <div class="flex space-x-3 pt-4 border-t border-gray-200">
                        ...
                        <button type="submit" :disabled="isSubmitting" class="flex-1 px-4 py-2 bg-orange-500 text-white font-semibold rounded-lg hover:bg-orange-600 transition-all duration-200 disabled:bg-gray-400 disabled:cursor-not-allowed">
