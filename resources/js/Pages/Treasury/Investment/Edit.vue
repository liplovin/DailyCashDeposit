...
// Watch for changes to the investment prop and populate the form
watch(() => props.investment, (newInvestment) => {
    if (newInvestment && newInvestment.id) {
        const existsInList = uniqueInvestments.value.some(a => a.investment_name === newInvestment.investment_name);
        ...
        form.value = {
            ...
            acquisition_date: formatDateDisplay(newInvestment.acquisition_date),
            customInvestment: !existsInList ? newInvestment.investment_name : '',
            explanation: newInvestment.explanation || ''
        };
    }
}, { deep: true });
...
const handleSubmit = () => {
    ...
    if (Object.keys(errors.value).length === 0) {
        ...
        router.put(`/treasury/investment/${props.investment.id}`, submitData, {
            onSuccess: () => {
                Swal.fire({
                    title: 'Updated!',
                    text: 'Investment has been updated successfully.',
                    icon: 'success',
...
const closeModal = () => {
    form.value = { investment_name: '', reference_number: '', beginning_balance: '', maturity_date: '', acquisition_date: '', customInvestment: '', explanation: '' };
    errors.value = {};
    emit('close');
};
        ...
        <div v-if="isOpen" class="fixed inset-0 bg-black/50 flex items-center justify-center z-50 p-4">
            ...
            <div class="bg-white rounded-xl shadow-2xl w-full max-w-md">
                ...
                <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200">
                    <h2 class="text-xl font-bold text-gray-900">Edit Investment</h2>
                    <button
                        @click="closeModal"
                ...
                <form @submit.prevent="handleSubmit" class="px-6 py-4 space-y-4">
                    ...
                    <!-- Custom Investment Field (appears when "Other" is selected) -->
                    <div v-if="form.investment_name === 'other'">
                        <label class="block text-sm font-semibold text-gray-900 mb-2">
                            Custom Investment Name <span class="text-red-500">*</span>
                        </label>
                        <input
