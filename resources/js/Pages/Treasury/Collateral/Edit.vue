...
watch(() => props.collateral, (newCollateral) => {
    if (newCollateral) {
        // Check if collateral is in the list
        const existsInList = uniqueCollaterals.value.some(c => c.collateral === newCollateral.collateral);
        
        form.value = {
            collateral: existsInList ? newCollateral.collateral : 'other',
            account_number: newCollateral.account_number,
            beginning_balance: formatBalanceDisplay(newCollateral.beginning_balance),
            maturity_date: formatDateDisplay(newCollateral.maturity_date),
            acquisition_date: formatDateDisplay(newCollateral.acquisition_date),
            customCollateral: !existsInList ? newCollateral.collateral : '',
            explanation: newCollateral.explanation || ''
        };
        errors.value = {};
    }
}, { deep: true });
...
const handleSubmit = () => {
    ...
    if (Object.keys(errors.value).length === 0) {
        ...
        router.put(`/treasury/collateral/${props.collateral.id}`, submitData, {
            onSuccess: () => {
                Swal.fire({
                    title: 'Updated!',
                    text: 'Collateral has been updated successfully.',
                    icon: 'success',
...
const closeModal = () => {
    form.value = { collateral: '', account_number: '', beginning_balance: '', maturity_date: '', customCollateral: '', acquisition_date: '', explanation: '' };
    errors.value = {};
    emit('close');
};
        ...
        <div v-if="isOpen" class="fixed inset-0 bg-black/50 flex items-center justify-center z-50 p-4">
            ...
            <div class="bg-white rounded-xl shadow-2xl w-full max-w-md">
                ...
                <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200">
                    <h2 class="text-xl font-bold text-gray-900">Edit Collateral</h2>
                    <button
                        @click="closeModal"
                ...
                <form @submit.prevent="handleSubmit" class="px-6 py-4 space-y-4">
                    ...
                    <div>
                        ...
                        >
                            ...
                            <option v-for="collateral in uniqueCollaterals" :key="collateral.collateral" :value="collateral.collateral">
                    ...
                    <!-- Custom Collateral Field (appears when "Other" is selected) -->
                    <div v-if="form.collateral === 'other'">
                        <label class="block text-sm font-semibold text-gray-900 mb-2">
                            Custom Collateral Name <span class="text-red-500">*</span>
                        </label>
                        <input
