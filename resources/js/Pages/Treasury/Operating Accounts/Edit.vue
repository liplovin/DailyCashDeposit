...
// Watch for changes to the operatingAccount prop and populate the form
watch(() => props.operatingAccount, (newOperatingAccount) => {
    if (newOperatingAccount && newOperatingAccount.id) {
        const existsInList = uniqueOperatingAccounts.value.some(a => a.operating_account_name === newOperatingAccount.operating_account_name);
        ...
        <div v-if="isOpen" class="fixed inset-0 bg-black/50 flex items-center justify-center z-50 p-4">
            ...
            <div class="bg-white rounded-xl shadow-2xl w-full max-w-md">
                ...
                <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200">
                    <h2 class="text-xl font-bold text-gray-900">Edit Operating Account</h2>
                    <button
                        @click="closeModal"
                ...
                <form @submit.prevent="handleSubmit" class="px-6 py-4 space-y-4">
                    ...
                    <!-- Custom Operating Account Field (appears when "Other" is selected) -->
                    <div v-if="form.operating_account_name === 'other'">
                        <label class="block text-sm font-semibold text-gray-900 mb-2">
                            Custom Operating Account Name <span class="text-red-500">*</span>
                        </label>
                        <input
