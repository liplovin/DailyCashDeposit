    ...
    <div v-if="isOpen" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div class="bg-white rounded-lg shadow-2xl w-full max-w-5xl max-h-[85vh] overflow-y-auto">
        ...
        <div class="sticky top-0 bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-4 flex justify-between items-center">
          <h2 class="text-white text-lg font-semibold">Operating Account History</h2>
          <button
            @click="$emit('close')"
        ...
        <div class="p-6">
          ...
          <div v-if="activeTab === 'renewals'">
            <div v-if="operatingAccount && operatingAccount.renewals && operatingAccount.renewals.length > 0" class="space-y-4">
              ...
              <div class="relative">
                <div class="space-y-6">
                  <div
                    v-for="(renewal, index) in operatingAccount.renewals"
                  ...
                  >
                    ...
                    <div v-if="index < operatingAccount.renewals.length - 1" class="absolute left-2 top-6 w-0.5 h-12 bg-blue-200"></div>
          ...
          <div v-if="activeTab === 'withdrawals'">
            <div v-if="operatingAccount && operatingAccount.withdrawals && operatingAccount.withdrawals.length > 0" class="space-y-4">
              <div
                v-for="withdrawal in operatingAccount.withdrawals"
              ...
              >
                ...
                <div class="grid grid-cols-3 gap-3 mb-5 pb-5 border-b border-orange-200">
                  <div class="bg-white rounded-lg p-4 border border-orange-100">
                    ...
                    <p class="text-xl font-bold text-gray-800">₱ {{ formatCurrency((operatingAccount?.beginning_balance || 0) + withdrawal.amount) }}</p>
                  </div>
                  ...
                  <div class="bg-green-50 rounded-lg p-4 border border-green-300">
                    ...
                    <p class="text-xl font-bold text-green-700">₱ {{ formatCurrency(operatingAccount?.beginning_balance || 0) }}</p>
                  </div>
                </div>
          ...
          <div v-if="activeTab === 'balances'">
            <div v-if="operatingAccount && operatingAccount.balances && operatingAccount.balances.length > 0" class="space-y-4">
              <div
                v-for="balance in operatingAccount.balances"
              ...
              >
                ...
                <div class="grid grid-cols-3 gap-3 mb-5 pb-5 border-b border-green-200">
                  <div class="bg-white rounded-lg p-4 border border-green-100">
                    <p class="text-xs text-gray-500 font-bold uppercase tracking-widest mb-2">Previous Balance</p>
                    <p class="text-xl font-bold text-gray-800">₱ {{ formatCurrency((operatingAccount?.beginning_balance || 0) - balance.amount) }}</p>
                  </div>
                  ...
                  <div class="bg-blue-50 rounded-lg p-4 border border-blue-300">
                    <p class="text-xs text-gray-500 font-bold uppercase tracking-widest mb-2">New Balance</p>
                    <p class="text-xl font-bold text-blue-700">₱ {{ formatCurrency(operatingAccount?.beginning_balance || 0) }}</p>
                  </div>
                </div>
