...
const handleSubmit = () => {
    ...
    if (Object.keys(errors.value).length === 0) {
        ...
        router.post('/treasury/cash-infusion', submitData, {
            onSuccess: () => {
                Swal.fire({
                    title: 'Created!',
                    text: 'Cash Infusion has been created successfully.',
                    icon: 'success',
...
const closeModal = () => {
    form.value = { cash_infusion_name: '', account_number: '', beginning_balance: '', maturity_date: '', customCashInfusion: '', acquisition_date: '', explanation: '' };
    errors.value = {};
    emit('close');
};
        ...
        <div v-if="isOpen" class="fixed inset-0 bg-black/50 flex items-center justify-center z-50 p-4">
            ...
            <div class="bg-white rounded-xl shadow-2xl w-full max-w-md">
                ...
                <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200">
                    <h2 class="text-xl font-bold text-gray-900">Create New Cash Infusion</h2>
                    <button
                        @click="closeModal"
                ...
                <form @submit.prevent="handleSubmit" class="px-6 py-4 space-y-4">
                    ...
                    <div>
                        ...
                        >
                            <option value="" disabled>-- Select Cash Infusion --</option>
                    ...
                    <!-- Custom Cash Infusion Input (shown when "Other" is selected) -->
                    <div v-if="form.cash_infusion_name === 'other'">
                        <label class="block text-sm font-semibold text-gray-900 mb-2">
                            Enter Cash Infusion Name <span class="text-red-500">*</span>
                        </label>
                        <input
