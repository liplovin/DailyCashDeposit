...
watch(() => props.timeDeposit, (newTimeDeposit) => {
    if (newTimeDeposit) {
        ...
        form.value = {
            ...
            acquisition_date: formatDateDisplay(newTimeDeposit.acquisition_date),
            customTimeDeposit: !existsInList ? newTimeDeposit.time_deposit_name : '',
            explanation: newTimeDeposit.explanation || ''
        };
        errors.value = {};
    }
}, { deep: true });
...
const closeModal = () => {
    form.value = { time_deposit_name: '', account_number: '', beginning_balance: '', maturity_date: '', acquisition_date: '', customTimeDeposit: '', explanation: '' };
    errors.value = {};
    emit('close');
};
