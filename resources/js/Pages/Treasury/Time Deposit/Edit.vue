...
// Watch for changes to the timeDeposit prop and populate the form
watch(() => props.timeDeposit, (newTimeDeposit) => {
    if (newTimeDeposit && newTimeDeposit.id) {
        const existsInList = uniqueTimeDeposits.value.some(d => d.time_deposit_name === newTimeDeposit.time_deposit_name);
