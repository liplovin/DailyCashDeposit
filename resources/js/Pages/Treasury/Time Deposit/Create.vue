...
const closeModal = () => {
    form.value = { time_deposit_name: '', account_number: '', beginning_balance: '', maturity_date: '', acquisition_date: '', explanation: '', customTimeDeposit: '' };
    errors.value = {};
    emit('close');
};
                ...
                <form @submit.prevent="handleSubmit" class="px-6 py-4 space-y-4">
                    ...
                    <div>
                        ...
                        >
                            ...
                            <option v-for="timeDeposit in uniqueTimeDeposits" :key="timeDeposit.id" :value="timeDeposit.time_deposit_name">
