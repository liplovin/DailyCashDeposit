    ...
    <div class="bg-white rounded-lg shadow-2xl w-full max-w-5xl max-h-[85vh] overflow-y-auto">
      ...
      <div class="p-6">
        ...
        <div v-if="activeTab === 'details'">
          <div v-if="timeDeposit" class="space-y-4">
            <!-- Time Deposit Basic Info Grid -->
            <div class="grid grid-cols-2 gap-4">
              <div class="bg-blue-50 rounded-lg p-4 border border-blue-200">
                <p class="text-xs text-gray-500 font-bold uppercase tracking-widest mb-2">Time Deposit Name</p>
                <p class="text-sm font-medium text-gray-900">{{ timeDeposit.time_deposit_name }}</p>
              </div>
              <div class="bg-blue-50 rounded-lg p-4 border border-blue-200">
                <p class="text-xs text-gray-500 font-bold uppercase tracking-widest mb-2">Account Number</p>
                <p class="text-sm font-medium text-gray-900">{{ timeDeposit.account_number }}</p>
              </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-4">
              <div class="bg-green-50 rounded-lg p-4 border border-green-200">
                ...
                <p class="text-sm font-medium text-gray-900">{{ formatDate(timeDeposit.acquisition_date) }}</p>
              </div>
              <div class="bg-yellow-50 rounded-lg p-4 border border-yellow-200">
                <p class="text-xs text-gray-500 font-bold uppercase tracking-widest mb-2">Maturity Date</p>
                <p class="text-sm font-medium text-gray-900">{{ formatDate(timeDeposit.maturity_date) }}</p>
              </div>
            </div>
            ...
            <div class="bg-white rounded-lg p-4 border border-blue-100">
              ...
              <p class="text-sm text-gray-700 leading-relaxed whitespace-pre-wrap break-words">{{ timeDeposit.explanation?.trim() || '—' }}</p>
            </div>
          </div>
        </div>
