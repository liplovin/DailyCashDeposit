...
const remainingBalance = computed(() => {
    const currentBalance = parseFloat(props.governmentSecurity?.beginning_balance || 0);
...
// Watch for government security changes and reset form
watch(() => props.governmentSecurity, (newGovSecurity) => {
    if (newGovSecurity && props.isOpen) {
        form.value = {
            amount: '',
            explanation: ''
        };
...
const handleSubmit = () => {
    ...
    router.post(
        `/treasury/government-securities/${props.governmentSecurity.id}/withdraw`,
        {
        ...
        },
        {
            onSuccess: () => {
                Swal.fire({
                    title: 'Withdrawn!',
                    text: 'Government security withdrawal has been recorded successfully.',
                    icon: 'success',
        ...
        <div v-if="isOpen" class="fixed inset-0 bg-black/50 flex items-center justify-center z-50 p-4">
            ...
            <div class="bg-white rounded-xl shadow-2xl w-full max-w-md">
                ...
                <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200">
                    <h2 class="text-xl font-bold text-gray-900">Withdraw Government Security</h2>
                    <button
                        @click="closeModal"
                ...
                <form @submit.prevent="handleSubmit" class="px-6 py-4 space-y-4">
                    ...
                    <div v-if="governmentSecurity" class="bg-orange-50 rounded-lg p-3 border border-orange-200">
                        ...
                        <p class="text-sm font-semibold text-gray-800 mt-1">
                            ...
                            ₱ {{ parseFloat(governmentSecurity.beginning_balance || 0).toLocaleString('en-PH', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) }}
                        </p>
                        <p class="text-orange-600 text-sm font-semibold mt-2">
                            ⚠️ This action will withdraw the specified amount from the government security.
                        </p>
                    </div>
                    ...
                    <div>
                        <div class="flex items-center justify-between mb-2">
                            ...
                            <button
                                type="button"
                                @click="form.amount = (governmentSecurity?.beginning_balance || 0).toString()"
                        ...
                        <div v-if="form.amount" class="mt-3 p-3 bg-blue-50 rounded-lg border border-blue-200">
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <p class="text-sm font-bold text-gray-900">₱ {{ formatCurrency(governmentSecurity?.beginning_balance || 0) }}</p>
                                </div>
                                <div>
