...
// Watch for changes to the governmentSecurity prop and populate the form
watch(() => props.governmentSecurity, (newGovernmentSecurity) => {
    if (newGovernmentSecurity && newGovernmentSecurity.id) {
        const existsInList = uniqueGovernmentSecurities.value.some(s => s.government_security_name === newGovernmentSecurity.government_security_name);
        
        form.value = {
            government_security_name: existsInList ? newGovernmentSecurity.government_security_name : 'other',
            reference_number: newGovernmentSecurity.reference_number || '',
            ...
            acquisition_date: formatDateDisplay(newGovernmentSecurity.acquisition_date),
            customGovernmentSecurity: !existsInList ? newGovernmentSecurity.government_security_name : '',
            explanation: newGovernmentSecurity.explanation || ''
        };
    }
}, { deep: true });
    ...
    if (Object.keys(errors.value).length === 0) {
        ...
        router.put(`/treasury/government-securities/${props.governmentSecurity.id}`, submitData, {
            onSuccess: () => {
                Swal.fire({
                    title: 'Updated!',
                    text: 'Government Security has been updated successfully.',
                    icon: 'success',
...
const closeModal = () => {
    form.value = { government_security_name: '', reference_number: '', beginning_balance: '', maturity_date: '', acquisition_date: '', customGovernmentSecurity: '', explanation: '' };
    errors.value = {};
    emit('close');
};
        ...
        <div v-if="isOpen" class="fixed inset-0 bg-black/50 flex items-center justify-center z-50 p-4">
            ...
            <div class="bg-white rounded-xl shadow-2xl w-full max-w-md">
                ...
                <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200">
                    <h2 class="text-xl font-bold text-gray-900">Edit Government Security</h2>
                    <button
                        @click="closeModal"
                ...
                <form @submit.prevent="handleSubmit" class="px-6 py-4 space-y-4">
                    ...
                    <div>
                        ...
                        >
                            <option value="">-- Select Government Security --</option>
                    ...
                    <!-- Custom Government Security Field (appears when "Other" is selected) -->
                    <div v-if="form.government_security_name === 'other'">
                        <label class="block text-sm font-semibold text-gray-900 mb-2">
                            Custom Government Security Name <span class="text-red-500">*</span>
                        </label>
                        <input
