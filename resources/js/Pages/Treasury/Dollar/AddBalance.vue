...
const handleSubmit = () => {
    ...
    router.post(
        `/treasury/dollar/${props.dollar.id}/add-balance`,
        {
                ...
                <form @submit.prevent="handleSubmit" class="px-6 py-4 space-y-4">
                    ...
                    <div v-if="dollar" class="bg-yellow-50 rounded-lg p-3 border border-yellow-200">
                        ...
                        <p class="text-sm font-semibold text-gray-800 mt-1">
                            ...
                            <span class="text-blue-600">{{ formatCurrency(dollar.beginning_balance) }}</span>
                        </p>
                    </div>
                    ...
                    <div v-if="form.amount && parseFloat(form.amount) > 0" class="bg-green-50 rounded-lg p-3 border border-green-200">
                        ...
                        <p class="text-lg font-semibold text-green-600">
                            {{ formatCurrency(parseFloat(dollar.beginning_balance || 0) + parseFloat(form.amount || 0)) }}
                        </p>
                    </div>
