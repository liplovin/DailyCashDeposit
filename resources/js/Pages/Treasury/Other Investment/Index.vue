...
const filteredOtherInvestments = computed(() => {
    if (!searchQuery.value.trim()) {
        return props.otherInvestments;
    }
    
    const query = searchQuery.value.toLowerCase();
    return props.otherInvestments.filter(investment => 
...
const handleDrop = (targetIndex) => {
    if (draggedIndex.value !== null && draggedIndex.value !== targetIndex) {
        const temp = props.otherInvestments[draggedIndex.value];
        props.otherInvestments[draggedIndex.value] = props.otherInvestments[targetIndex];
        props.otherInvestments[targetIndex] = temp;
    }
        ...
        <div class="w-full px-8">
            ...
            <div class="mb-8">
                <div class="flex items-center justify-between mb-6">
                    <div>
                        <h1 class="text-3xl font-black text-gray-900">Other Investments Management</h1>
                        <p class="text-gray-600 mt-1">Manage and track your other investments</p>
                    </div>
                    <button
                        @click="openModal"
                    ...
                    <table class="w-full border-collapse">
                        ...
                        <tfoot>
                            <tr class="bg-yellow-50 border-t-2 border-gray-300 font-bold">
                                <td class="px-6 py-4 text-sm text-gray-900 border-r border-gray-300">SUB-TOTAL OTHER INVESTMENTS</td>
