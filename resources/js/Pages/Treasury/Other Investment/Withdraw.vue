...
const remainingBalance = computed(() => {
    const currentBalance = parseFloat(props.otherInvestment?.beginning_balance || 0);
...
// Watch for other investment changes and reset form
...
const handleSubmit = () => {
    ...
    router.post(
        `/treasury/other-investment/${props.otherInvestment.id}/withdraw`,
        {
        ...
        },
        {
            onSuccess: () => {
                Swal.fire({
                    title: 'Withdrawn!',
                    text: 'Other investment withdrawal has been recorded successfully.',
                    icon: 'success',
        ...
        <div v-if="isOpen" class="fixed inset-0 bg-black/50 flex items-center justify-center z-50 p-4">
            ...
            <div class="bg-white rounded-xl shadow-2xl w-full max-w-md">
                ...
                <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200">
                    <h2 class="text-xl font-bold text-gray-900">Withdraw Other Investment</h2>
                    <button
                        @click="closeModal"
                ...
                <form @submit.prevent="handleSubmit" class="px-6 py-4 space-y-4">
                    <!-- Investment Info -->
                    <div v-if="otherInvestment" class="bg-orange-50 rounded-lg p-3 border border-orange-200">
                        <p class="text-sm font-semibold text-gray-800">
                            <span class="text-gray-600">Investment:</span> {{ otherInvestment.other_investment_name }}
                        </p>
                        <p class="text-sm font-semibold text-gray-800 mt-1">
                            <span class="text-gray-600">Account:</span> {{ otherInvestment.account_number }}
                        </p>
                        <p class="text-sm font-semibold text-gray-800 mt-1">
                            <span class="text-gray-600">Amount:</span> 
                            ₱ {{ parseFloat(otherInvestment.beginning_balance || 0).toLocaleString('en-PH', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) }}
                        </p>
                    ...
                    <div>
                        <div class="flex items-center justify-between mb-2">
                            ...
                            <button
                                type="button"
                                @click="form.amount = (otherInvestment?.beginning_balance || 0).toString()"
                        ...
                        <div v-if="form.amount" class="mt-3 p-3 bg-blue-50 rounded-lg border border-blue-200">
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <p class="text-sm font-bold text-gray-900">₱ {{ formatCurrency(otherInvestment?.beginning_balance || 0) }}</p>
                                </div>
                                <div>
