...
// Watch for other investment changes and populate form
        ...
        <div v-if="isOpen" class="fixed inset-0 bg-black/50 flex items-center justify-center z-50 p-4">
            ...
            <div class="bg-white rounded-xl shadow-2xl w-full max-w-md">
                ...
                <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200">
                    <h2 class="text-xl font-bold text-gray-900">Renew Other Investment</h2>
                    <button
                        @click="closeModal"
                ...
                <form @submit.prevent="handleSubmit" class="px-6 py-4 space-y-4">
                    <!-- Investment Info -->
                    <div v-if="otherInvestment" class="bg-yellow-50 rounded-lg p-3 border border-yellow-200">
                        ...
                        <p class="text-sm font-semibold text-gray-800 mt-1">
                            ...
                            {{ new Intl.DateTimeFormat('en-US', { year: 'numeric', month: 'short', day: 'numeric' }).format(new Date(otherInvestment.maturity_date)) }}
                        </p>
                    </div>
