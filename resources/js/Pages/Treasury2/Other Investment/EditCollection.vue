...
watch(() => props.otherInvestment, (newInvestment) => {
    if (newInvestment && props.isOpen) {
        amount.value = newInvestment.collection || 0;
    }
}, { deep: true, immediate: true });

watch(() => props.isOpen, (isOpen) => {
    if (isOpen && props.otherInvestment) {
        amount.value = props.otherInvestment.collection || 0;
    }
});
...
const handleSubmit = async () => {
    ...
    try {
        await axios.put(`/treasury2/other-investment/${props.otherInvestment?.id}/collection`, {
