...
const handleCollection = (investment) => {
    Swal.fire({
        title: 'Collection',
        text: `Add collection for ${investment.other_investment_name}`,
        icon: 'info',
...
const handleDisbursement = (investment) => {
    Swal.fire({
        title: 'Disbursement',
        text: `Add disbursement for ${investment.other_investment_name}`,
        icon: 'info',
        ...
        <div class="w-full px-8 py-12">
            ...
            <div class="mb-8">
                <div class="flex items-center justify-between mb-6">
                    <h1 class="text-3xl font-black text-gray-900">Other Investment Management</h1>
                </div>
            </div>
