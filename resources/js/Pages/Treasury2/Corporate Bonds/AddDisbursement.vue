...
const handleSubmit = async () => {
    ...
    try {
        const response = await axios.post(`/treasury2/corporate-bonds/${props.corporateBond?.id}/disbursement`, {
        ...
        <div class="bg-white rounded-2xl shadow-2xl max-w-md w-full animation-fade-in overflow-hidden">
            ...
            <div class="px-6 py-6 space-y-5">
                ...
                <div class="bg-gradient-to-br from-red-50 to-red-100 border-2 border-red-200 rounded-xl p-5">
                    ...
                    <p class="text-lg font-bold text-red-900">{{ corporateBond?.corporate_bond_name || 'N/A' }}</p>
                    <p class="text-sm text-red-700 mt-2 font-mono">{{ corporateBond?.account_number }}</p>
