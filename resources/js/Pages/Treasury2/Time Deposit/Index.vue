...
const handleCollection = (deposit) => {
    Swal.fire({
        title: 'Collection',
        text: `Add collection for ${deposit.time_deposit_name}`,
        icon: 'info',
...
const handleDisbursement = (deposit) => {
    Swal.fire({
        title: 'Disbursement',
        text: `Add disbursement for ${deposit.time_deposit_name}`,
        icon: 'info',
                    ...
                    <table class="w-full border-collapse">
                        ...
                        <tbody>
                            ...
                            >
                                ...
                                <td class="px-6 py-4 text-sm text-gray-700 border-r border-gray-200">{{ formatDate(deposit.maturity_date) }}</td>
