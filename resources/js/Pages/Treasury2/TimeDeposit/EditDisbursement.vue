...
watch(() => props.timeDeposit, (newTimeDeposit) => {
    if (newTimeDeposit && props.isOpen) {
        amount.value = newTimeDeposit.disbursement || 0;
    }
}, { deep: true, immediate: true });

watch(() => props.isOpen, (isOpen) => {
    if (isOpen && props.timeDeposit) {
        amount.value = props.timeDeposit.disbursement || 0;
    }
});
...
const handleSubmit = async () => {
    ...
    try {
        await axios.put(`/treasury2/time-deposit/${props.timeDeposit?.id}/disbursement`, {
