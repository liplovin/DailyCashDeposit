...
onMounted(() => {
    document.title = 'Other Investment - Daily Deposit';
    investmentsData.value = props.otherInvestments;
});
...
<template>
    <AdminLayout>
        <div class="w-full px-8 py-6">
            ...
            <div class="mb-8">
                <h1 class="text-4xl font-black text-gray-900 mb-2">Other Investment Accounts</h1>
                <p class="text-gray-600 text-sm font-medium">View alternative investment accounts with collection and disbursement tracking</p>
            </div>
                    ...
                    <table class="w-full border-collapse">
                        ...
                        <tbody>
                            ...
                            >
                                ...
                                <td class="px-6 py-4 text-sm text-blue-600 font-semibold">{{ formatCurrency(getRollingBeginningBalance(investment) + getCollectionAmount(investment) - getDisbursementAmount(investment)) }}</td>
                            </tr>
                        </tbody>
