                    ...
                    <table class="w-full border-collapse">
                        ...
                        <tbody>
                            ...
                            >
                                ...
                                <td class="px-6 py-4 text-sm text-blue-600 font-semibold">{{ formatCurrency(getRollingBeginningBalance(deposit, filterDate) + parseFloat(getCollectionAmount(deposit)) - parseFloat(getDisbursementAmount(deposit))) }}</td>
                            </tr>
                        </tbody>
