...
import ShowDisbursement from '@/Pages/Accounting/Operating Accounts/ShowDisbursement.vue';
    ...
    <AdminLayout>
        <div class="w-full px-8">
                ...
                <div class="flex gap-4 flex-col md:flex-row">
                    ...
                    <div class="relative w-full md:w-48">
                        ...
                        <input
                            ...
                            class="w-full pl-12 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-transparent transition-all duration-200 text-gray-900"
                        />
                    </div>
                </div>
            </div>
            ...
            <div v-else-if="(searchQuery || filterDate) && filteredDisbursements.length === 0" class="max-w-6xl">
                <div class="bg-yellow-50 rounded-2xl border-2 border-yellow-200 p-12 text-center">
                    <div class="inline-block">
                        <div class="w-16 h-16 bg-yellow-200 rounded-full flex items-center justify-center mb-4">
                            <Search class="h-8 w-8 text-yellow-600" />
                        </div>
                    </div>
            ...
            <div v-else class="bg-white rounded-xl border-2 border-gray-300 shadow-lg overflow-hidden">
                <div class="overflow-x-auto">
                    <table class="w-full border-collapse">
                        ...
                        <tbody>
                            <template v-for="(accountData, accountId) in groupedByOperatingAccount" :key="accountId">
                                ...
                                >
                                    ...
                                    <td class="px-6 py-4 text-sm text-center">
                                        <button
                                            ...
                                            class="inline-flex items-center px-4 py-2 rounded-lg bg-yellow-500 text-white hover:bg-yellow-600 font-semibold text-sm transition-colors"
                                        >
                                            Show Details
                                        </button>
                                    </td>
                                ...
                                <tr class="bg-yellow-50 border-b-2 border-yellow-300">
                                    ...
                                    <td class="px-6 py-4 text-sm font-bold text-yellow-700 text-right border-r border-gray-300">
                        ...
                        <tfoot class="bg-yellow-100 border-t-2 border-gray-300">
                            <tr>
