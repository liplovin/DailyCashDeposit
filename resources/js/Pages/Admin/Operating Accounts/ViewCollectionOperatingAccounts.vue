...
const selectedAccountData = ref({ accountName: '', collections: [] });
...
const handleShowDetails = (collections, accountName) => {
    selectedAccountData.value = { accountName, collections };
...
<template>
    <Head title="Processed Collection - Operating Accounts" />
    <AdminLayout>
        ...
        <ShowCollection 
            ...
            :collections="selectedAccountData.collections"
