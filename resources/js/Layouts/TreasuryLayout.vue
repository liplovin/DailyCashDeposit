...
onMounted(() => {
    const savedState = localStorage.getItem('treasury_sidebar_open');
    if (savedState !== null) {
...
watch(sidebarOpen, (newValue) => {
    localStorage.setItem('treasury_sidebar_open', JSON.stringify(newValue));
});
...
const isRouteActive = (routeName) => {
    const routeList = {
        'dashboard': '/dashboard',
        'treasury.collateral': '/treasury/collateral',
    ...
    // Check for exact match or if current path starts with route path (for sub-pages like create)
...
const menuItems = [
    ...
    },
    {
        name: 'Collateral',
        component: Shield,
        route: 'treasury.collateral'
    },
    {
        name: 'Time Deposit',
        component: Clock,
        route: 'treasury.time-deposit'
    },
    {
        name: 'Government Securities',
        component: FileText,
        route: 'treasury.government-securities'
    },
    {
        name: 'Other Investment',
        component: TrendingUp,
        route: 'treasury.other-investment'
    },
    {
